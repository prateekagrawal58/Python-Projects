...
class View:
    def __init__(self, top):
        ...
        #self.songTimePassed.configure(text='''1:15''')
        ...
        # self.nextButton.place(relx=0.800, rely=0.285, height=16, width=16)
        # self.nextButton.configure(background="#000")
        ...
        # self._img6 = tk.PhotoImage(file="./icons/pause.png")
        #self.nextButton.configure(image=self._img6)
        ...
        self.vol_scale = ttk.Scale(self.top)
    ...
    def setup_player(self):
        ...
        x = self.my_player.my_model.get_db_status()
        if x:
    ...
    def show_song_details(self):
        ...
        #song_name_str = str(self.song_name)
    ...
    def load_next_song(self):
        print("curr index:",self.sel_song_index_tuple[0])
        print("In load next song Playlist size is:", self.playList.count())
    ...
    def __init__(self, master):
        ...
        for meth in methods:
            if meth[0] != '_' and meth not in ('config', 'configure'):
                if hasattr(master, meth):
                    setattr(self, meth, getattr(master, meth))


    def _autoscroll(_, sbar):
